...
<div id="main-content">
        <div class="container-fluid">
            ...
            <br><br>
             ...
             <div class="body">
                 <form id="basic-form" method="post"action="{{url('update_subcategory')}}" novalidate enctype="multipart/form-data">
                                           {{ csrf_field() }}
                        ...
                        <?php
                            ...
                            if( $subimage == '' && $subimage == NULL){
                                    ...
                                    &nbsp;  &nbsp;<img src="uploads/category/{{$cat->sub_image}}" width="280" height="100"><br><br><br>
                            <?php } ?>
