                    ...
                    <div class="card">
                        <div class="header">
                            ...
                            <ul class="nav nav-tabs-new ">
                                ...
                                <li class="nav-item" style="margin-top: -5px;font-size: x-large;"><a class="nav-link"  href="{{url('newArea')}}">اضافة مدينة</a></li>
                            </ul>
                        </div>
                        <div class="body">
                                       ...
                                       @foreach($data as $cat)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <form action="{{url('editArea')}}" method="GET"  id="sub_{{$cat->id}}" enctype="multipart/form-data">
                                            ...
                                            <td>
                                               ...
                                               <form action="{{url('delete_area')}}" method="GET"  id="sub_{{$cat->id}}" enctype="multipart/form-data">
