              ...
              <div class="col-lg-12 restaurent-meal-head mb-md-40">
                <div class="card">
                  <div class="card-body no-padding">
                    <div class="row">
                      <div v-for="place in categoryPlaces" :key="place.id" class="col-lg-12">
                                  ...
                                  <div class="restaurent-product-price">
                                    <div class="pl-social-media">
                                      <ul>
                                        ...
                                        <li>
                                          <a class="rect-tag fav" href="javascript:void(0)" @click="toggleFavCategoryPlace(place.id)">
...
export default {
  ...
  methods: {
    async fetchCategoryPlaces(id) {
      await this.$store.dispatch("place/fetchCategoryPlaces", {
        id: id,
      });
      this.$store.dispatch("general/changeWait", { wait: false });
    },
    async toggleFavCategoryPlace(id) {
      await this.$store.dispatch("place/toggleFavCategoryPlace", {id: id});
    },
  },
  async created() {
